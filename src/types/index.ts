...
// Re-export shared domain types (GUI + TUI)
export type {
  AgentRole,
  AgentStatus,
  CliProvider,
...
export { WORKFLOW_PACK_KEYS } from "../../shared/types";

// Department (GUI-only: agent_count display, full name fields)
...
export interface WSEvent {
  type: import("../../shared/types").WSEventType;
  payload: unknown;
}
