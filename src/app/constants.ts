...
export const MAX_CLIENT_OFFICE_CALLS = 480;
...
export const UPDATE_BANNER_DISMISS_STORAGE_KEY = "agentdesk_update_banner_dismissed";
export const ROOM_THEMES_STORAGE_KEY = "agentdesk_room_themes";
