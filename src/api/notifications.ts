...
export interface NotificationItem {
  id: string;
  type: "task_complete" | "task_error" | "task_started" | "kickoff" | "decision_created" | "agent_error" | "system" | "cost_alert" | "agent_anomaly" | "heartbeat" | "pm_approved" | "pm_revision" | "version_released";
  title: string;
  body: string | null;
  task_id: string | null;
