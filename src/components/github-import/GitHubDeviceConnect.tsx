...
export default function GitHubDeviceConnect({ reason, onConnected, onCancel }: GitHubDeviceConnectProps) {
  ...
  return (
    <div className="space-y-4 p-6">
      <p className="text-sm font-mono" style={{ color: "var(--th-text-secondary)" }}>{description}</p>
      ...
      {deviceStatus === "waiting" && deviceUserCode && (
        <div className="space-y-3 p-4" style={{ borderRadius: 8, border: "1px solid var(--th-accent-border-subtle)", background: "var(--th-accent-bg-subtle)" }}>
          ...
          <div className="flex items-center gap-3">
            <code className="px-4 py-2 text-lg font-bold tracking-widest font-mono"
              style={{ borderRadius: 8, background: "var(--th-terminal-bg)", color: "var(--th-accent)" }}>
              {deviceUserCode}
            </code>
            <button
              type="button"
          ...
          {deviceVerifyUrl && (
            <a
              ...
              className="inline-block text-xs font-mono underline"
          ...
          <p className="animate-pulse text-xs font-mono" style={{ color: "var(--th-text-muted)" }}>
      ...
      {deviceStatus === "complete" && (
        <div className="px-3 py-2 text-xs font-mono" style={{ borderRadius: 8, border: "1px solid rgba(52,211,153,0.35)", background: "rgba(52,211,153,0.08)", color: "rgb(167,243,208)" }}>
          {t({
