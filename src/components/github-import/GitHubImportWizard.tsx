      ...
      <div className="flex items-center gap-2 px-5 py-3" style={{ borderBottom: "1px solid #E5E7EB" }}>
        <button
          ...
          style={step === "repo"
            ...
            : { borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-elevated)", color: "var(--th-text-secondary)" }}
        >
        ...
        <button
          ...
          onClick={onCancel}
          className="px-3 py-1 text-xs font-mono transition"
          style={{ borderRadius: 0, border: "1px solid #E5E7EB", color: "var(--th-text-muted)" }}
        >
      ...
      <div className="flex-1 overflow-y-auto p-5">
        {step === "repo" && (
          <div className="space-y-3">
            <div className="space-y-2 p-3" style={{ borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-surface)" }}>
        ...
        {step === "branch" && selectedRepo && (
          <div className="space-y-3">
            <div className="px-4 py-2" style={{ borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-surface)" }}>
                ...
                {branches.map((branch) => (
                  <button
                    ...
                    style={branch.is_default
                      ...
                      : { borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-surface)" }}
                  >
                    <div className="flex items-center gap-2">
