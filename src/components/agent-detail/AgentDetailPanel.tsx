...
export default function AgentDetailPanel() {
  ...
  const tk = {
    ...
    headerBg:     "#F9FAFB",
    headerBorder: "#E5E7EB",
    shadow:       "0 24px 80px rgba(0,0,0,0.10), 0 4px 16px rgba(0,0,0,0.06), 0 0 0 0.5px rgba(0,0,0,0.04)",
              ...
              {TABS.map((tab) => (
                <button
                  ...
                  style={{
                    ...
                    color: activeTab === tab.key ? "#3B82F6" : tk.tabInactive,
                    cursor: "pointer",
