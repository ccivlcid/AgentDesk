    ...
    return (
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="border rounded p-3 text-center" style={{ background: "var(--th-bg-surface)", borderColor: "var(--th-border)", borderRadius: 14 }}>
      ...
      <div className="space-y-2">
        {agentTasks.length === 0 ? (
          ...
          agentTasks.map((taskItem) => {
            ...
            return (
              <div key={taskItem.id} className="border rounded p-3" style={{ background: "var(--th-bg-surface)", borderColor: "var(--th-border)", borderRadius: 14 }}>
                <button
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {subTotal > 0 && (
                      <div className="flex items-center gap-2 mt-1.5">
                        <div className="flex-1 h-1 overflow-hidden" style={{ borderRadius: 4, background: "var(--th-border)" }}>
                          <div
