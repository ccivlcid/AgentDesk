        ...
        <div className="space-y-4 overflow-y-auto px-5 py-4">
          ...
          <div>
            ...
            <input
              ...
              style={{ borderRadius: 0, background: "var(--th-bg-elevated)", border: "1px solid #E5E7EB", color: "var(--th-text-primary)" }}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              style={{ borderRadius: 0, background: "var(--th-terminal-bg)", border: "1px solid #E5E7EB" }}
            />
            <div className="flex items-center justify-between mt-1.5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  style={{ borderRadius: 0, background: "var(--th-bg-primary)", border: "1px solid #E5E7EB", color: "var(--th-text-secondary)" }}
                >
