          ...
          >
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                ...
                {/* Priority badge */}
                <span className="inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium font-mono border" style={{ borderRadius: 0, background: "var(--th-bg-primary)", color: "var(--th-text-muted)", borderColor: "var(--th-border)" }}>
                  P{hook.priority}
                </span>
