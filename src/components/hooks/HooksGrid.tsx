      ...
      {filtered.map((hook) => {
        ...
        return (
          ...
          >
            ...
            {/* Command preview */}
            <div className="mb-3 px-2 py-1.5 border" style={{ borderRadius: 8, background: "var(--th-terminal-bg)", borderColor: "var(--th-border)" }}>
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 flex-wrap min-w-0">
                ...
                {hook.scope_type && hook.scope_type !== "global" && (() => {
                  ...
                  return sbColor ? (
                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[10px] font-mono border" style={{ borderRadius: 8, background: `${sbColor}18`, color: sbColor, borderColor: `${sbColor}44` }}>
                      <ScopeBadgeIcon scope={hook.scope_type} /> {hook.scope_type}
                    </span>
                  ) : null;
                })()}
                {/* Event type badge */}
                <span className={`inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-medium font-mono border ${etColor}`} style={{ borderRadius: 8 }}>
                  {eventTypeLabel(hook.event_type, t)}
                </span>
                {/* Priority badge */}
                <span className="inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium font-mono border" style={{ borderRadius: 8, background: "var(--th-bg-primary)", color: "var(--th-text-muted)", borderColor: "var(--th-border)" }}>
                  P{hook.priority}
                </span>
                ...
                {hook.last_executed_at && (
                  <span className="inline-flex items-center px-1.5 py-0.5 text-[10px] font-medium font-mono border" style={{ borderRadius: 8, background: "var(--th-bg-elevated)", color: "var(--th-text-muted)", borderColor: "var(--th-border)" }}>
