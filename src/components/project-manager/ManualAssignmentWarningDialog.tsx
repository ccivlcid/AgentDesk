  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center bg-black/70 p-4" onClick={onCancel}>
      <div
        ...
        style={{ borderRadius: 0, border: "1px solid rgba(245,158,11,0.4)", background: "#F9FAFB" }}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="border-b border-amber-500/30 px-4 py-3">
          <h3 className="text-xs font-bold uppercase tracking-widest" style={{ color: "#3B82F6", fontFamily: "var(--th-font-mono)" }}>
        ...
        <div className="space-y-2 px-4 py-4">
          ...
          <div className="px-3 py-2 text-[11px] font-mono" style={{ borderRadius: 0, border: "1px solid #E5E7EB", background: "#FFFFFF", color: "#6B7280" }}>
            <p>
