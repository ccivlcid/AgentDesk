  ...
  return (
    <>
      {(isCreating || !!editingProjectId) && (
        <div className="mt-2 space-y-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-1 p-0.5" style={{ border: "1px solid #E5E7EB", borderRadius: 0, background: "var(--th-bg-elevated)" }}>
              <button
                type="button"
                onClick={() => {
                ...
                style={{
                  ...
                  color: assignmentMode === "auto" ? "var(--th-bg-elevated)" : "var(--th-text-muted)",
                }}
              >
          ...
          {assignmentMode === "manual" && (
            <div className="space-y-2 p-3" style={{ borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-elevated)" }}>
              ...
              <div className="flex flex-wrap items-center gap-1.5 text-[11px]">
                <span className="px-2 py-0.5 font-mono" style={{ borderRadius: 0, border: "1px solid #E5E7EB", background: "var(--th-bg-surface)", color: "var(--th-text-secondary)" }}>
                ...
                <span className="px-2 py-0.5 font-mono text-emerald-300" style={{ borderRadius: 0, border: "1px solid rgba(16,185,129,0.3)", background: "rgba(16,185,129,0.1)" }}>
      ...
      {!isCreating && !editingProjectId && selectedProject && selectedProject.assignment_mode === "manual" && (
        <div className="mt-2 px-3 py-2" style={{ borderRadius: 0, border: "1px solid rgba(124,58,237,0.3)", background: "rgba(124,58,237,0.08)" }}>
