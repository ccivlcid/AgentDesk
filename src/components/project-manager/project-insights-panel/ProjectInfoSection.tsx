    ...
    <div className="min-w-0 p-4" style={{ border: "1px solid #E5E7EB", borderRadius: 0, background: "#F9FAFB" }}>
      ...
      {loadingDetail ? (
        ...
        <div className="mt-2 space-y-2 text-xs">
          <p className="font-mono text-xs" style={{ color: "#111827" }}>
            <span style={{ color: "#9CA3AF" }}>ID:</span> {selectedProject.id}
          </p>
          <p className="break-all font-mono text-xs" style={{ color: "#111827" }}>
            <span style={{ color: "#9CA3AF" }}>Path:</span> {selectedProject.project_path}
          </p>
          <p className="break-all font-mono text-xs" style={{ color: "#111827" }}>
            <span style={{ color: "#9CA3AF" }}>Goal:</span> {selectedProject.core_goal}
          </p>
        </div>
      )}
    </div>
