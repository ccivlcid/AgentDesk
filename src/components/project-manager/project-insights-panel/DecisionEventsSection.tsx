            ...
            return (
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <p className="min-w-0 truncate text-xs font-semibold font-mono" style={{ color: "#111827" }}>
                    {getDecisionEventLabel(event.event_type)}
                  </p>
                  <p className="text-[11px] font-mono" style={{ color: "#9CA3AF" }}>{fmtTime(event.created_at)}</p>
                </div>
                <p className="mt-1 whitespace-pre-wrap break-all text-[11px] font-mono" style={{ color: "#6B7280" }}>{event.summary}</p>
