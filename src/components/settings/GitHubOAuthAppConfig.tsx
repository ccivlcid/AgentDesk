...
export default function GitHubOAuthAppConfig({ t }: { t: TFunction }) {
  ...
  return (
    <div className="space-y-2 p-4" style={{ borderRadius: 8, border: "1px solid #E5E7EB", background: "var(--th-bg-surface)" }}>
      ...
      {ghClientIdLoaded && (
        <div className="flex gap-2 items-center">
          <input
            ...
            className="flex-1 px-3 py-1.5 text-xs font-mono outline-none" style={{ borderRadius: 8, border: "1px solid #E5E7EB", background: "var(--th-bg-elevated)", color: "var(--th-text-primary)" }}
          />
          <button
