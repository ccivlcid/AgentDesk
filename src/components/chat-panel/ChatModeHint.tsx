import { IconChartBar, IconClipboard, IconMegaphone } from "../ui/SvgIcons";
        ...
        <>
          {mode === "task" && (
            <p className="flex items-start gap-1.5 text-xs text-amber-400">
              <IconClipboard size={14} className="mt-0.5 flex-shrink-0" />
              <span>
                {tr(
          ...
          {mode === "announcement" && (
            <p className="flex items-start gap-1.5 text-xs text-yellow-400">
              <IconMegaphone size={14} className="mt-0.5 flex-shrink-0" />
              <span>
                {tr(
          ...
          {mode === "report" && (
            <p className="flex items-start gap-1.5 text-xs text-emerald-400">
              <IconChartBar size={14} className="mt-0.5 flex-shrink-0" />
              <span>
                {tr(
