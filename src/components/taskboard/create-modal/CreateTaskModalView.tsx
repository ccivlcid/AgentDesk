...
export default function CreateTaskModalView({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {/* Right-side header actions (templates + drafts) */}
      {((templates && templates.length > 0 && onLoadTemplate) || draftsCount > 0) && (
        <div className="flex items-center gap-1.5 px-3 pb-1 pt-0.5 flex-shrink-0">
          {templates && templates.length > 0 && onLoadTemplate && (
            <div className="relative">
              ...
              {templateMenuOpen && (
                <div
                  className="absolute left-0 top-full z-10 mt-1 w-52 max-h-52 overflow-y-auto"
