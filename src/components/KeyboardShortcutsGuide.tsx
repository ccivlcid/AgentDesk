  ...
  const sections = [
    {
      ...
      rows: [
        ...
        { keys: ["Ctrl", "3"], desc: t({ ko: "에이전트 관리", en: "Agents", ja: "エージェント", zh: "代理管理" }) },
        { keys: ["Ctrl", "4"], desc: t({ ko: "스킬 라이브러리", en: "Skills", ja: "スキル", zh: "技能库" }) },
        { keys: ["Ctrl", "5"], desc: t({ ko: "메모리", en: "Memory", ja: "メモリー", zh: "记忆" }) },
        { keys: ["Ctrl", "6"], desc: t({ ko: "에이전트 룰", en: "Agent Rules", ja: "エージェントルール", zh: "代理규칙" }) },
        { keys: ["Ctrl", "7"], desc: t({ ko: "훅", en: "Hooks", ja: "フック", zh: "钩子" }) },
        { keys: ["Ctrl", "8"], desc: t({ ko: "설정", en: "Settings", ja: "設定", zh: "设置" }) },
      ],
    },
    {
      title: t({ ko: "g + 키 네비게이션 (vim 스타일)", en: "g + key Navigation (vim-style)", ja: "g + キーナビ（vim スタイル）", zh: "g 前缀导航（vim 风格）" }),
      rows: [
        { keys: ["g", "d"], desc: t({ ko: "대시보드로 이동", en: "Go to Dashboard", ja: "ダッシュボードへ", zh: "跳转至仪表板" }) },
