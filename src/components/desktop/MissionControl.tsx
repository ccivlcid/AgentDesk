...
export default function MissionControl({ openWindows, onClose, onFocusWindow }: MissionControlProps) {
  ...
  const WINDOW_META: Record<WindowType, { icon: ReactNode; label: string }> = {
    ...
    tasks:           { icon: <svg {...S}><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>, label: t({ ko: "워크플로우",         en: "Workflow",       ja: "ワークフロー",         zh: "工作流" }) },
    ...
    "cli-usage":         { icon: <svg {...S}><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, label: t({ ko: "CLI 사용량",       en: "CLI Usage",      ja: "CLI使用量",             zh: "CLI用量" }) },
