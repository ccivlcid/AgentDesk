...
export default function MissionControl({ openWindows, onClose, onFocusWindow }: MissionControlProps) {
  ...
  const WINDOW_META: Record<WindowType, { icon: ReactNode; label: string }> = {
    ...
    tasks:           { icon: <svg {...S}><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>, label: t({ ko: "오케스트레이션",     en: "Orchestration",  ja: "オーケストレーション", zh: "编排" }) },
