...
- 로컬 기준 프로젝트: AgentDesk (`README.md`, `package.json`, `docs/api.md`, `docs/progress.md` 기준)
...
- `docs/api.md`에는 메시징, 디렉티브, 디시전 인박스, 부서/에이전트/태스크 API가 폭넓게 정의되어 있다.
...
상세 적용안은 `docs/agentdesk-symphony-adoption-plan.md`에 정리했다.
