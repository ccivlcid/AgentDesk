...
| Doc | Status |
|---|---|
| `docs/design/design-system.md` | DONE (main reference) |
| `docs/strategy/agent-persona-system.md` | DONE |
| `docs/design/office-view-tower-redesign.md` | DONE |
| `docs/strategy/ui-differentiation-strategy.md` | DONE (existing) |
| `docs/reference/progress.md` (this file) | DONE |
...
**Ref**: `docs/design/design-retro-terminal-overhaul.md`
...
**Ref**: `docs/design/office-view-tower-redesign.md` Section 9
...
| Task | File | Status |
|---|---|---|
| `docs/design/DESIGN.md` 전면 재작성 (영문, FM2024 스타일) | `docs/design/DESIGN.md` | DONE |
| `docs/design/design-system.md` 레이어 테이블 + Office View 섹션 추가 | `docs/design/design-system.md` | DONE |
| `docs/design/office-view-tower-redesign.md` Section 9 FM UI Wrapper 추가 | `docs/design/office-view-tower-redesign.md` | DONE |
...
설계 문서: `docs/reference/office-pack-phase17.md`
...
**설계 문서**: `docs/reference/phaser-migration.md`
...
**설계 문서**: `docs/strategy/pack-identity-system.md`
...
**설계 방안 7가지** (`docs/design/office-view-tower-redesign.md` Section 7):
...
- Retro Terminal reference: `docs/design/design-retro-terminal-overhaul.md`
- Persona reference: `docs/strategy/agent-persona-system.md`
- Office view reference: `docs/design/office-view-tower-redesign.md`
