/**
 * AgentDesk Introduction Presentation Generator
...
pptx.company = "AgentDesk";
pptx.subject = "AgentDesk Introduction";
pptx.title = "AgentDesk — AI Agent Office Simulator";
...
// ═══════════════════════════════════════════════
{
  ...
  s.addText("github.com/agentdesk/agentdesk", {
    x: 0.8,
    y: 4.8,
    w: 8,
    h: 0.3,
    ...
    fontFace: "Arial",
    color: C.textDim,
    hyperlink: { url: "https://github.com/agentdesk/agentdesk" },
  });
}
...
// ═══════════════════════════════════════════════
{
  ...
  s.addText(
    "Webhook endpoint: POST /api/inbox  |  Secret: x-inbox-secret header  |  Config: ~/.agentdesk/agentdesk.json",
    {
      x: 0.6,
      y: 4.65,
      w: 8.8,
...
// ═══════════════════════════════════════════════
{
  ...
  const links = [
    ["GitHub", "github.com/agentdesk/agentdesk"],
    ["License", "Apache 2.0"],
