...
export const DEFAULT_WORKFLOW_PACK_SEEDS: WorkflowPackSeed[] = [
  ...
  },
  {
    ...
    inputSchema: {
      required: ["asset_class", "investment_goal", "risk_level"],
      optional: ["time_horizon", "benchmark", "constraints", "portfolio_size"],
    },
    promptPreset: {
    ...
    outputTemplate: {
      sections: ["executive_summary", "market_analysis", "portfolio_recommendation", "risk_assessment", "compliance_notes"],
    },
    routingKeywords: ["investment", "portfolio", "fund", "asset", "risk", "투자", "펀드", "자산", "운용", "포트폴리오", "수익률", "리스크", "배분"],
    costProfile: {
      ...COMMON_COST_PROFILE,
      maxRounds: 3,
      defaultReasoning: "high",
