 ...
 */
function migrateProjectScopeType(db: DbLike): void {
  // --- agent_rules ---
  const arDdl = (
...
function applyV2CategoryMigrations(db: DbLike): void {
 ...
 */
function migrateSkillLearningHistoryScope(db: DbLike): void {
...
function seedPipelineGates(db: DbLike): void {
